...
""", """
    ...
    ;
""", """
    ALTER TABLE `cart_cartitem` ADD CONSTRAINT cart_bundle_id_refs_id_7caeda34 FOREIGN KEY (`cart_bundle_id`) REFERENCES `cart_cartbundle` (`id`);
""", """
    ...
    ;
""", """
    ALTER TABLE `cart_cartbundle_cart_items` ADD CONSTRAINT cartbundle_id_refs_id_982f798 FOREIGN KEY (`cartbundle_id`) REFERENCES `cart_cartbundle` (`id`);
""", """
...
""", """
    ALTER TABLE `cart_cartitem` DROP FOREIGN KEY cart_bundle_id_refs_id_7caeda34;
""", """
